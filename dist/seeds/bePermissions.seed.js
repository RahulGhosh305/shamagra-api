...
const addPermissions = () => {
    setTimeout(async () => {
        ...
        console.log(arr);
        await beUmPermission_model_1.UmPermissionModel.deleteMany({});
        await beUmPermission_model_1.UmPermissionModel.insertMany(arr, (error, docs) => {
            if (error)
                console.log(error);
        });
