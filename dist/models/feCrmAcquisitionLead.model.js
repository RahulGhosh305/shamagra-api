...
exports.CrmAcquisitionLeadStatus = exports.CrmAcquisitionLeadModel = void 0;
...
exports.CrmAcquisitionLeadStatus = documentStatus;
...
const beUserSchema = new mongoose_1.Schema({
    _id: { type: mongoose_1.default.Types.ObjectId, required: false, ref: 'be_user' },
    firstName: { type: String, required: false, default: null },
    lastName: { type: String, required: false, default: null },
    email: { type: String, required: false, default: null },
    phone: { type: String, required: false, default: null },
...
const acquisitionSchema = new mongoose_1.Schema({
    _id: { type: mongoose_1.default.Types.ObjectId, required: false, ref: 'fe_crm_acquisition_form' },
...
const documentModel = (0, mongoose_1.model)("fe_crm_acquisition_lead", documentSchema);
exports.CrmAcquisitionLeadModel = documentModel;
