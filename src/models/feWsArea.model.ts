...
const citySchema = new Schema({
    _id: { type: mongoose.Types.ObjectId, required: false, ref: 'fe_ws_city' },
    name: { type: String, required: false, default: null },
    latitude: { type: Number, required: false, default: null },
    longitude: { type: Number, required: false, default: null }
},{ _id : false });
...
const locationSchema = new Schema({
    _id: { type: mongoose.Types.ObjectId, required: false, ref: 'fe_ws_location' },
    name: { type: String, required: false, default: null },
    latitude: { type: Number, required: false, default: null },
    longitude: { type: Number, required: false, default: null }
},{ _id : false });
...
const documentModel = model<DocumentType>("fe_ws_area", documentSchema);
export {documentModel as WsAreaModel, documentStatus as WsAreaStatus}
